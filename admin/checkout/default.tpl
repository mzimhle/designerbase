                    ...
                    <div class="col-md-3">				    
        				<div class="form-group">
        					...
        					<select type="text" id="filter_status" name="filter_status" class="form-control">
                                ...
                                {html_options options=$statusPairs}
        					</select>
        				</div>
        			</div>
                    <div class="col-md-3">				    
        				<div class="form-group">
        					...
        					<select type="text" id="filter_stage" name="filter_stage" class="form-control">
        						<option value=""> All </option>
                                {html_options options=$stagePairs}
        					</select>
        				</div>
        			</div>        			
        			<div class="col-md-3">	
        				<div class="form-group">
        				  ...
        				  <select type="text" id="filter_brand" name="filter_brand" class="form-control">
        					<option value=""> All </option>
        					{html_options options=$brandPairs}
        				  </select>
        				</div>
				    </div>
        			<div class="col-md-3">	
        				<div class="form-group">
        				  ...
        				  <select type="text" id="filter_areapostregion" name="filter_areapostregion" class="form-control">
        					<option value=""> All </option>
        					{html_options options=$areapostregionPairs}
        				  </select>
        				</div>
				    </div>				    
        		</div>
	...
	$.ajax({
		...
		success: function(data){
			if(data.result == 1) {
                ...
                img.src = '{/literal}{$config.site}{literal}'+data.data.media_path+'tny_'+data.data.media_code+data.data.media_ext+'?rand='+Math.floor(Math.random() * 10000);
