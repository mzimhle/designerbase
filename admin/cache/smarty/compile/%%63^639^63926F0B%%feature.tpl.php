<?php /* Smarty version 2.6.20, created on 2018-09-11 22:44:07
         compiled from catalog/feature.tpl */ ?>
<!DOCTYPE html>
        ...
        <div class="col-sm-12">
          <div class="portlet">
			...
			<div class="portlet-content">	
				...
				<br /><br />
				<form id="validate-basic" action="/dashboard/feature/default.php?code=<?php echo $this->_tpl_vars['itemData']['item_code']; ?>
...
var category = \''; ?>
<?php echo $this->_tpl_vars['catalogData']['item_parent_name']; ?>
<?php echo '\';
...
function addFeature() {
	...
	if(items.length > 0) {
		$.ajax({
			type: "GET",
			url: "feature.php?add_feature=1&code='; ?>
...
function getAll() {
	...
	oTable = $(\'#dataTable\').dataTable({
		...
		"bProcessing": true,
		"bServerSide": true,		
		"sAjaxSource": "?action=tablesearch&filter_type="+type+"&code='; ?>
<?php echo $this->_tpl_vars['catalogData']['catalog_code']; ?>
<?php echo '",
...
function makePrimary() {
	...
	$.ajax({
		type: "GET",
		url: "feature.php",
		data: "update_primary_size="+primarycode+"&code='; ?>
<?php echo $this->_tpl_vars['catalogData']['catalog_code']; ?>
<?php echo '",
		dataType: "json",
		success: function(data){
...
function updatePriceModal(featurecode) {
	...
	$.ajax({
		type: "GET",
		url: "feature.php",
		data: "get_price_size="+featurecode+"&code='; ?>
<?php echo $this->_tpl_vars['catalogData']['catalog_code']; ?>
<?php echo '",
		dataType: "json",
		success: function(data){
...
function updatePrice() {
	...
	$.ajax({
		type: "GET",
		url: "feature.php",
		data: "add_price_size="+feature+"&price_code="+price_code+"&price_original="+price_original+"&price_discount="+price_discount+"&code='; ?>
<?php echo $this->_tpl_vars['catalogData']['catalog_code']; ?>
<?php echo '",
		dataType: "json",
		success: function(data){
