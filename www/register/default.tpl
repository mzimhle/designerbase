                ...
                <div class="row">
                    <div class="col-md-12">
						<div class="page-header" style="margin-top: -32px;">
							<h1>Sign Up</h1>
							<p>Below is a form where you will add all your details in order to create an account.</p>
						</div><!-- End .page-header -->
							...
							<div class="row">
								...
								<div class="col-sm-4">
									<div class="form-group">
										...
										<input type="text" class="form-control" id="participant_email" name="participant_email" required />
									</div><!-- End .form-group -->
								</div><!-- End .col-sm-4 -->
								...
								<div class="col-sm-4">
									<div class="form-group">
										...
										<input type="text" class="form-control" id="participant_number" name="participant_number" required />
									</div><!-- End .form-group -->
								</div><!-- End .col-sm-4 -->
							</div><!-- End .row -->
							{if isset($errors)}
