...
<head>
    <meta charset="utf-8">
    <title>DesignerBase - Page not Found</title>
    <!--[if IE]> <meta http-equiv="X-UA-Compatible" content="IE=edge"> <![endif]-->
    <meta name="viewport" content="width=device-width, initial-scale=1.0">	
	<meta name="keywords" content="online catalog, product list, page not found">
	<meta name="description" content="Designer Base - Page not Found">         
	...
	<meta property="og:description" content="Designer Base - Page not Found">
    <!-- Google Fonts -->
                ...
                <div class="row">
                    <div class="col-md-12">
					   <div class="error-page text-center">
							...
							<p class="scroll-anim" data-anim="fadeInUp" data-anim-delay="0.4s">We're sorry, the page you requested cannot be found. Please go back to home page.</p>
